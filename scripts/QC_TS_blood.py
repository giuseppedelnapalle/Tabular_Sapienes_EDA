...
# -*- coding: utf-8 -*-
"""
QC of the Tabular Sapiens blood dataset
...
# 2 QC the Tabular Sapiens blood dataset
...
# sc.pp.filter_genes(adata_s, min_counts=100)
adata_s.var.columns
adata_s.var.highly_variable.sum()
# 2391
# dispersions
adata_s.var.dispersions.median()
adata_s.var.dispersions.mean()
adata_s.var.dispersions.min()
adata_s.var.dispersions.max()
adata_s.var.dispersions.std()
# dispersions_norm
# For the dispersion-based methods ([Satija15] and [Zheng17]), the normalized dispersion is obtained by 
# scaling with the mean and standard deviation of the dispersions for genes falling into a given bin 
# for mean expression of genes. This means that for each bin of mean expression, highly variable 
# genes are selected.
# https://scanpy.readthedocs.io/en/stable/generated/scanpy.pp.highly_variable_genes.html
adata_s.var.dispersions_norm.median()
adata_s.var.dispersions_norm.mean()
adata_s.var.dispersions_norm.min()
adata_s.var.dispersions_norm.max()
adata_s.var.dispersions_norm.std()
# thres_g = adata_s.var.dispersions_norm.median() - 2*adata_s.var.dispersions_norm.std()
# thres_g = adata_s.var.dispersions_norm.median() - adata_s.var.dispersions_norm.std()
thres_g = adata_s.var.dispersions_norm.median()
adata_s[:,adata_s.var.dispersions_norm >= thres_g]
